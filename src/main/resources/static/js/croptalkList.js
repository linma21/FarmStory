...
window.onload = function (){
    ...
    if(cate === 'story'){
        communityNav.innerHTML = `<img src="../images/sub_aside_cate3_tit.png" alt="농작물이야기"/>
                                                <p> HOME > 농작물이야기 > <em>농작물이야기</em></p>`;
    } else if(cate === 'grow'){
        communityNav.innerHTML = `<img src="../images/sub_nav_tit_cate5_tit2.png" alt="귀농학교"/>
                                                <p> HOME > 농작물이야기 > <em>귀농학교</em></p>`;
    } else if(cate === 'chef'){
        communityNav.innerHTML = `<img src="../images/sub_nav_tit_cate5_tit3.png" alt="텃밭가꾸기"/>
