...
## 유스케이스 다이어그램
모든 사용자들(회원, 비회원)은 상품과 게시글을 볼 수 있다.✅

비회원은 회원가입을 할 수 있다.✅
비회원은 상품 주문을 할 수 없다.❌
비회원은 주문 목록에 접속할 수 없습니다.❌
비회원은 게시글,댓글 작성을 할 수 없다.❌

회원은 로그인을 할 수 있다.✅
회원은 상품 주문을 할 수  있다.✅
회원은 상품 주문 후 리뷰 작성을 할 수 있다.✅
회원은 주문 목록에 접속할 수 있다.✅
회원은 게시글,댓글 작성을 할 수 있다.✅
회원은 중복해서 회원가입을 할 수 없다.❌
회원은 공지사항, 이벤트, 자주묻는질문엔 글쓰기를 할 수 없다.❌
회원은 관리자 페이지에 접근 할 수 없다.❌

관리자는 고객 정보를 관리할 수 있다.✅
관리자는 상품 관리할 수 있다.✅
관리자는 매출을 조회할 수 있다.✅
관리자는 모든 게시판에 글쓰기를 할 수 있다.✅
